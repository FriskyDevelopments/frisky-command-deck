...
export function SystemLayer({ visible }: SystemLayerProps) {
    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-extralight tracking-[0.3em] uppercase text-foreground/80 mb-4">
              System Layer
            </h2>
